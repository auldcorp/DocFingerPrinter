...
function spawn_crawler($url, $db)
{
    ...
    $crawler->setLinkExtractionTags(array("href","img","src","url","location","codebase","background","data","profile","action","open","value"));
    $crawler->setFollowMode(0);
    $crawler->requestGzipContent(TRUE);
    $crawler->enableCookieHandling(TRUE);
    $crawler->setCrawlingDepthLimit(25);
    $crawler->setUserAgentString("Mozilla/5.0 (Macintosh; Intel Mac OS X 10.11; rv:50.0) Gecko/20100101 Firefox/50.0");
    ...
    $crawler->addContentTypeReceiveRule("#text/[a-zA-Z\-]{2,10}#");
    $crawler->addContentTypeReceiveRule("#application/[a-zA-Z\-]{2,10}#");
